    ...
    def display_simple_table(self, g_vars, item_list, title="", justify=True):
        ...
        if title != "":
            ...
            g_vars["draw"].rectangle(
                ...
                fill=THEME.simple_table_title_background.value,
            )
            ...
            g_vars["draw"].text(
                ...
                title,
                font=font_type,
                fill=THEME.simple_table_title_foreground.value,
            )
        ...
        if (
            g_vars["current_scroll_selection"] + table_display_max
            > g_vars["table_list_length"]
        ):
        ...
        for item in item_list:
            ...
            self.draw.text(
                ...
                item,
                font=font_type,
                fill=THEME.simple_table_row_foreground.value,
            )
